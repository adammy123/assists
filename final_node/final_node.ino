...
bool targetResponseCheck = false;
...
//  if(!targetResponseCheck){
//    Serial.println("Waiting for target response check");
...
//    while( !radio.write( &targetResponseCheck, sizeof(targetResponseCheck) )){}
//    radio.startListening();
//  }
